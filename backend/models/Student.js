...
// Add virtual or just extra fields
StudentSchema.add({
  isContestEnded: { type: Boolean, default: false },
  contestEndedAt: { type: Date, default: null },
  finalTimeBonus: { type: Number, default: 0 },
  finalTotalScore: { type: Number, default: 0 }
});
